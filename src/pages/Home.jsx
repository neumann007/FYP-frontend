            ...
            <div id="baby">
              <div id="inner">
                ...
                <div id="pain_content">
                  ...
                  know how challenging that can be, which is why we're <br />
          ...
          <div className="carousel-item">
            ...
            <div id="baby">
              <div id="inner">
                ...
                <div id="pain_content">
                  {" "}
                  Are you ready to spoil your fluffly comparison? Don't <br />
            ...
            <div id="baby">
              <div id="inner">
                ...
                <div id="pain_content">
                  ...
                  you struggle to get the nutrients you need from your <br />{" "}
                  diet alone? Introducing the ultimate food supplement <br />
        ...
        <div className="row g-0">
          ...
          <div className="col-md-5">
            <div className="card-body">
              <p className="card-title"> Feel Better Without a Prescription </p>
